...
nextjs:
  metadata:
    title: Example
    description: An example of how to use NetWizard.
---

This is an example of NetWizard. You can study the source code to learn more about how it works. Find more examples in the repository itself: [Click here](https://github.com/ayushsharma82/NetWizard/blob/main/examples)
